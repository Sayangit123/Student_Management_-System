        ...
        <div class="row">
          ...
          <main class="col-md-10 ml-sm-auto col-lg-10 px-4 content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
              <a class="navbar-brand" href="#">Edit Instructor</a>
            </nav>
              ...
              <div class="card-body">
                <form action="{{route('instructors.update')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="instructor" name="instructor" placeholder="Enter instructor name" value="{{$instructors->name ?? '-' }}">
                  </div>
                 ...
                 @endif
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="experience" name="experience" placeholder="Enter experience" value="{{$instructors->experience ?? '-' }}">
                  </div>
                 ...
                 @endif
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="position" name="position" value="{{$instructors->position ?? '-' }}">
                  </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="course_taught" name="course_taught" value="{{$instructors->course_taught ?? '-' }}">
                      </div>
